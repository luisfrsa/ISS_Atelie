...
public class FormGerenciarProdutos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblEstoque.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        lblEstoque.setText("Estoque");

        btnEstoque.setBackground(new java.awt.Color(153, 204, 255));
        btnEstoque.setText("Ir para Estoque de Produtos");
    ...
    private void btnAjudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAjudaActionPerformed
        try {
            java.awt.Desktop.getDesktop().browse(new java.net.URI("https://github.com/luisfrsa/ISS_Atelie/tree/master/ajuda#gerenciar-produtos"));
    ...
    public JToggleButton getBtnEstoque() {
        return btnEstoque;
    }
